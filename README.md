...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/azure-aks/)
...
```bash
kubectl port-forward deployment/tp-azure-aks 8080:8080
```
...
```bash
kubectl run load-generator --image=busybox --restart=Never -- /bin/sh -c "while true; do wget -q -O- http://tp-azure-aks; done"
```
...
# Primary Config File: aks_cluster.tf
```
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/azure-aks/) |
